...
function pushFace(vertices, uvs, normals, a, b, c, d, normal) {
...
export class GameMap {
            ...
            for (let z = 0; z < this.size; z++) {
                ...
                if (height >= 1) {
                    for (let y = 0; y < height; y++) {
                        ...
                        // pass normals into each pushFace call:
                        pushFace(vertices, uvs, normals, [x0,y0,z0], [x1,y0,z0], [x1,y1,z0], [x0,y1,z0], [0,0,-1]); // front
                        pushFace(vertices, uvs, normals, [x1,y0,z1], [x0,y0,z1], [x0,y1,z1], [x1,y1,z1], [0,0,1]);  // back
                        pushFace(vertices, uvs, normals, [x0,y0,z1], [x0,y0,z0], [x0,y1,z0], [x0,y1,z1], [-1,0,0]); // left
                        pushFace(vertices, uvs, normals, [x1,y0,z0], [x1,y0,z1], [x1,y1,z1], [x1,y1,z0], [1,0,0]);  // right
                        pushFace(vertices, uvs, normals, [x0,y1,z0], [x1,y1,z0], [x1,y1,z1], [x0,y1,z1], [0,1,0]);  // top
                        pushFace(vertices, uvs, normals, [x0,y0,z1], [x1,y0,z1], [x1,y0,z0], [x0,y0,z0], [0,-1,0]); // bottom
                    }
                }
            }
        }
    ...
    draw() {
        ...
        if (g_normalOn) gl.uniform1i(u_whichTexture, -3);
